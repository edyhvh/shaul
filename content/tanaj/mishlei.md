...
- #navon: el que entiende con el corazón, al navon no se le necesita explicar el mashal, es el amigo del novio (lev navon, #misheli_8_5, #misheli_15_14, #mishlei_18_15 ) → נבון
...
- #letz: burlador, es un paso mas del evil porque persigue a los que escogen seguir la torá → לץ
	- Shaul (Pablo) era un letz pero debido a la jesed de Yeshúa, fue humillado
- #tojajá: es el golpe que recibes del ruaj ha'kodesh que rompe el orgullo y te salva, son básicamente las palabras de Yeshúa cuando le dijo a Shaul: "Shaul, Shaul, por qué me persigues?", es el dolor que te causa las palabras de Elohim exponiendo directamente tu pecado